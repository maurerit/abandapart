...
public interface IndustryCalculationService {
    /**
     * Convenience overload of {@link IndustryCalculationService#calculateBuildCosts(String, Long, IndustrySkillConfiguration, InventionSkillConfiguration, Integer, Integer, boolean, boolean)}
