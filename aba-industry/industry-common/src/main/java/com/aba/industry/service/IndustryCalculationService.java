...
public interface IndustryCalculationService {
    /**
     * Convenience overload of {@link IndustryCalculationService#calculateBuildCosts(Long, IndustrySkillConfiguration, InventionSkillConfiguration, Integer, boolean, boolean)}
